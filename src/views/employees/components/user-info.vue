<template>
  <div class="user-info">
    <el-row type="flex" justify="end">
      <el-tooltip content="打印个人基本信息" placement="bottom-end">
...
import { getUserDetailById, updatePersonal } from '@/api/user'
import { saveUserDetailById, getEmployeeSimple } from '@/api/employees'
...
export default {
  ...
  methods: {
    ...
    async getUserInfo() {
      ...
      // 获取到用户的头像数据
      // 点击更新的时候,需要获取组件的内部的fileList进行提交
